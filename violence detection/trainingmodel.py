...
checkpoint = ModelCheckpoint('violence_detection_model_bestnew.h5', monitor='val_loss', save_best_only=True, mode='min', verbose=1)

# Train the model with the checkpoint callback
history = model.fit(X_train, y_train, batch_size=32, epochs=13, validation_data=(X_val, y_val), callbacks=[checkpoint])
